...
file_list = [
    ...
    # "mountain_survival.jsonl",
    "general_knowledge_sorted_unique.jsonl"
]
...
def process_jsonl_line(line):
    ...
    try:
        ...
        if len(assistant_message.split(" ")) < 12:  # has to be larger than some length
            return None
        ...
        generated_messages = [generate_message(user_message, new_assistant_message)]
        ...
        for language in extra_languages:
            ...
            translated_new_user_message = argostranslate.translate.translate(
                user_message, "en", language
            )
            ...
            generated_messages.append(
                generate_message(translated_new_user_message, translated_new_assistant_message)
            )
